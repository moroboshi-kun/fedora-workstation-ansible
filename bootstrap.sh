...
ANSIBLE_REPO_HTTPS="https://github.com/moroboshi-kun/fedora-workstation-ansible.git"
ANSIBLE_DIR="${HOME}/Development/ansible/fedora-workstation-ansible"
...
ansible-playbook "${ANSIBLE_DIR}/site.yml" --ask-become-pass
